                        ...
                        <div className="mt-5">
                            ...
                            <p className="text-muted mb-0">
                                <FormattedMessage
                                    ...
                                    defaultMessage="Desarrollo de aplicaciones del lado del servidor, como así también configuración y conexión a bases de datos."
                                />
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="mt-5">
                            ...
                            <h3 className="h4 mb-2">
                                <FormattedMessage
                                    ...
                                    defaultMessage="Diseño responsive"
                                />
                            </h3>
                            <p className="text-muted mb-0">
                                <FormattedMessage
                                    id='services.responsiveDescription'
                                    defaultMessage="Creación de aplicaciones adaptables a cualquier tipo de dispositivo!"
                                />
                            </p>
                        </div>
                    </div>
