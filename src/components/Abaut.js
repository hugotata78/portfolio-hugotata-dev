            ...
            <div className="container px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5 justify-content-center">
                    <div className="move col-lg-8 text-center">
                        ...
                        <a className="btn btn-light btn-lg p-3" href="https://drive.google.com/file/d/14kInSg2q3ZNmyiilxIzFXLKd3OavCu7l/view?usp=sharing" target='_blank'>Descargar CV</a>
                    </div>
                </div>
            </div>
        </section>
