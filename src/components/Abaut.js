            ...
            <div className="container px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5 justify-content-center">
                    <div className="move col-lg-8 text-center">
                        ...
                        <a className="btn btn-light btn-lg p-3" href="https://drive.google.com/file/d/1nr5WMg8KJeeG_Hrv8sQ-9usopvbpTCN9/view?usp=sharing" target='_blank' rel="noreferrer">Descargar CV</a>
                    </div>
                </div>
            </div>
        </section>
